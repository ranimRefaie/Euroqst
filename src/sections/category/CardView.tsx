...
const Card: React.FC<CardProps> = ({ image, text }) => (
  <div className="w-[140px] h-[160px] md:w-[30.5%] md:h-[133px] relative mb-10 ">
...
export const CardView = () => {
  return (
      <div className="w-full mt-8 md:w-[92%] mx-auto flex justify-center md:justify-start flex-wrap   gap-3">
