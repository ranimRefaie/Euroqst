...
export const HeaderIndex = () => {
  return (
    <div className='h-auto header-home pb-4 md:pb-0 md:h-[93vh] '>
      <div className="main-header  w-full"><Navbar />
        <div className="mt-[95px] ">
          ...
          <p className='text-[20px] md:text-[30px] font-normal leading-[57.24px] tracking-[-0.6655414700508118px] text-center text-[#ffffff] mt-10'>In-House , Classroom , Online Courses</p>
      ...
      <div className="hidden hero-down absolute top-[94%] w-[78%] mx-auto bg-[#293352] rounded-[100px] md:flex justify-between px-[44.5px] py-[22px]">
      <button className='mb-4 w-[100%] px-4 py-3 md:px-[22px] md:py-[10.5px] rounded-[20px] bg-[#FFFFFF0A] md:bg-transparent md:w-auto md:mb-0  text-[#ffffff] border border-[#FFFFFF]  cursor-pointer text-[14px] font-medium flex items-center justify-center'>Enter Keyword</button>
