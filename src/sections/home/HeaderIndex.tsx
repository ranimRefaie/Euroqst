...
export const HeaderIndex = () => {
  return (
    <div className='h-auto header-home pb-4 md:pb-0 md:h-[70vh] '>
      ...
      <div className="hidden hero-down absolute top-[92%] w-[78%] mx-auto bg-[#293352] rounded-[100px] md:flex justify-between px-[44.5px] py-[22px]">
